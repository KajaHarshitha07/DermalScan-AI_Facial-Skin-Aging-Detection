...
DermalScan:AI_Facial Skin Aging
Detection App
...
augmentation, and classification with percentage predictions. A web-based frontend will enable
users to upload images and visualize aging signs with annotated bounding boxes and labels.

Outcomes:
● Detect and localize facial features indicating aging.
● Classify detected features into categories like wrinkles, dark spots, puffy eyes, and clear skin
...
● Integrate a backend pipeline that processes input images and returns annotated
results. ● Export annotated outputs and logs for documentation or analysis.
